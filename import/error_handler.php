...
function userErrorHandler ($errno, $errmsg, $filename, $linenum, $vars) { 
        ...
        global $install_path,$install_directory;
        ...
        $logfile_path = $install_path . $install_directory . '/logtrace/ERRORLOG.TXT';
        if (is_writable($logfile_path)) { 
//error_log($err, 3, $logfile_path);
 }
